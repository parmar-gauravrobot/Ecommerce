              ...
              <div className="offcanvas-body justify-content-between">
                ...
                <div className="d-none d-lg-flex align-items-end">
                  <ul className="d-flex justify-content-end list-unstyled m-0">
                    ...
                    <li>
  <a href="index.html" className="mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasFavorites" aria-controls="offcanvasFavorites">
    <iconify-icon icon="mdi:heart" className="fs-4" />
      ...
      <ul className="list-group mb-3">
        ...
        <li className="list-group-item d-flex justify-content-between lh-sm">
          <div>
            ...
            <small className="text-body-secondary">Your contact number</small>
          </div>
          <span className="text-body-secondary">+1 234 567 890</span>
        </li>
        <li className="list-group-item d-flex justify-content-between lh-sm">
          <div>
          ...
          <span className="text-body-secondary">1 hour ago</span>
        </li>
      </ul>
...
//     setModalContent(contentType); // Set the modal content based on the button clicked
...
//             {/* Icon for Cart, Profile, Wishlist - Modal Trigger */}
...
//       {/* Reusable Modal */}
//       <div
//         className={`offcanvas offcanvas-end ${isModalOpen ? 'show' : ''}`}
//         tabIndex={-1}
//         id="offcanvasModal"
...
//           <h5 className="offcanvas-title" id="offcanvasModalLabel">
//             {modalContent === 'profile' && 'Profile'}
//             {modalContent === 'wishlist' && 'Wishlist'}
//             {modalContent === 'cart' && 'Shopping Cart'}
//           </h5>
//           <button
//             type="button"
//             className="btn-close"
...
//           {modalContent === 'profile' && <p>Your profile details go here.</p>}
//           {modalContent === 'wishlist' && <p>Your wishlist items go here.</p>}
//           {modalContent === 'cart' && <p>Your shopping cart content goes here.</p>}
//         </div>
//       </div>
//     </>
//   );
